  ...
  <nav class="navbar  ">
        ...
        <div class=" flutuacao">
          <form class="d-flex" role="search">
            ...
            <div class="navegar" id="navbarScroll" >
              <div class=" links">
                <a class="active link" aria-current="page" href="#">Início</a>
              </div>
              <div class=" links">
                <a class="active link" aria-current="page" href="#">Meu Perfil</a>
              </div>
              <div class=" links">
                <a class="active link" aria-current="page" href="#">Meus Projetos</a>
              </div>
              <div class=" links">
                <a class="active link" aria-current="page" href="#">Todos os Projetos</a>
              </div>
              <div class=" links">
                <a class="active link" aria-current="page" href="#" >Pesquisa</a>
              </div>
              <div class=" links">
                <a class="active link" aria-current="page" href="#">Extensão</a>
              </div>
              <div class=" flutuacao d">
